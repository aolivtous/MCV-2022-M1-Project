...
def init(name_query):
    ...
    # in_db_threshold = 0.195 # Color + Texture + Text 
    in_db_threshold = 0.2 * 1e-7 # ORB Features
    # in_db_threshold = 0.2*1e-14 # ORB Features
    # in_db_threshold = 1.958 * 1e-15 # 0.2*1e-14
